...
namespace TygaSoft.IDAL
{
    public partial interface IContentDetail
    {
        ...
        /// <returns></returns>
        List<ContentDetailInfo> GetList(int pageIndex, int pageSize, out int totalRecords, string sqlWhere, params SqlParameter[] cmdParms);
        ...
        /// </summary>
        /// <returns></returns>
        List<ContentDetailInfo> GetList();
