<%@ Page Title="新建楼单元信息" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="AddResidentialUnit.aspx.cs" Inherits="TygaSoft.Web.Admin.BasicData.AddResidentialUnit" %>
...
<div class="easyui-panel" title="填写信息" data-options="fit:true" style="padding:10px;"> 
   ...
   <div class="row">
        <span class="fl rl" style="width:140px;"><b class="cr">*</b>单元号：</span>
        <div class="fl">
   ...
   <div class="row mt10">
        ...
        <div class="fl">
            <a href="javascript:void(0)" id="lbtnSelect" class="easyui-linkbutton" data-options="iconCls:'icon-add',plain:true" onclick="AddResidentialUnit.OnDlgOpenClick()">选 择</a>
        </div>
        <span class="clr"></span>
    </div>
    <div class="row mt10">
    ...
    <div class="row mtb10">
        ...
        <div class="fl">
            <a href="javascript:void(0)" class="easyui-linkbutton" data-options="iconCls:'icon-save'" onclick="AddResidentialUnit.OnSave()">提 交</a>
        </div>
        <span class="clr"></span>
    </div>
...
<div id="dgCompanyToolbar" style="padding:5px;">
    ...
    <a href="javascript:void(0)" class="easyui-linkbutton" data-options="iconCls:'icon-search'" onclick="AddResidentialUnit.OnSearchCompany()">查 詢</a>
</div>

<div id="dgCommunityToolbar" style="padding:5px;">
    小区名称：<input type="text" id="txtCommunityName" maxlength="50" class="txt" />
    <a href="javascript:void(0)" class="easyui-linkbutton" data-options="iconCls:'icon-search'" onclick="AddResidentialUnit.OnSearchCommunity()">查 詢</a>
</div>
<div id="dgBuildingToolbar" style="padding:5px;">
    楼号：<input type="text" id="txtBuildingCode" maxlength="50" class="txt" />
    <a href="javascript:void(0)" class="easyui-linkbutton" data-options="iconCls:'icon-search'" onclick="AddResidentialUnit.OnSearchBuilding()">查 詢</a>
</div>
...
buttons: [{
	...
	handler:function(){
		AddResidentialUnit.OnDlgSelect();
	}
},{
...
}],onOpen:AddResidentialUnit.OnDlgOpen()" style="width:780px;height:400px;">
    <div id="tabParent" class="easyui-tabs" data-options="border:false,fit:true"></div>
</div>

<script type="text/javascript" src="/House/Scripts/Admin/AddResidentialUnit.js"></script>
<script type="text/javascript">
    $(function () {
        try {
            AddResidentialUnit.Init();
        }
        catch (e) {
