...
<head runat="server">
    ...
    <script src="/House/Scripts/Jquery/jquery-1.10.2.min.js" type="text/javascript"></script>
    <script src="/House/Scripts/Plugins/jeasyui/jquery.easyui.min.js" type="text/javascript"></script>
    <script src="/House/Scripts/Plugins/jeasyui/locale/easyui-lang-zh_CN.js" type="text/javascript"></script>
...
<body>
    ...
    <div class="w login">
        <div class="main">
            <div class="loginl">
	            <img src="/House/Images/loginl.jpg" alt="" />
            </div>
            <div class="loginr">
                ...
                <div id="loginInfo" class="content">
                    ...
                    <div class="control-group">
                        ...
                        <img border="0" id="imgCode" src="/House/Handlers/ValidateCode.ashx?vcType=login" alt="看不清，单击换一张" onclick="this.src='/House/Handlers/ValidateCode.ashx?vcType=login&abc='+Math.random()" />
                    </div>
    ...
    <script type="text/javascript" src="/House/Scripts/Login.js"></script>
</body>
</html>
