...
namespace TygaSoft.SqlServerDAL
{
    public partial class Announcement : IAnnouncement
    {
        ...
        {
            string cmdText = @"insert into Announcement (ContentTypeId,Title,Descr,ContentText,LastUpdatedDate)
			                 values
        ...
        {
            string cmdText = @"update Announcement set ContentTypeId = @ContentTypeId,Title = @Title,Descr = @Descr,ContentText = @ContentText,LastUpdatedDate = @LastUpdatedDate 
			                 where Id = @Id";
