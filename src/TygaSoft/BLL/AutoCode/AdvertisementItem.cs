...
{
    public partial class AdvertisementItem
    {
        private static readonly IAdvertisementItem dal = DataAccess.CreateAdvertisementItem();

        #region AdvertisementItem Member
