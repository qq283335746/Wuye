<%@ Page Title="公共区域投诉维修" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="ListPubilcComplainRepair.aspx.cs" Inherits="TygaSoft.Web.Admin.Repair.ListPubilcComplainRepair" %>
...
<table id="dgT" class="easyui-datagrid" title="公共区域投诉保修列表" data-options="rownumbers:true,pagination:true,fit:true,fitColumns:true,toolbar:'#toolbar'">
    <thead>
        <tr>
            <th data-options="field:'f0',checkbox:true"></th>
            <th data-options="field:'Status',hidden:true"></th>
            <th data-options="field:'f1',width:100">联系方式</th>
            <th data-options="field:'f2',width:300">描述</th>
            <th data-options="field:'f3',width:80,formatter:ComplainRepair.StatusFormatter">处理状态</th>
            <th data-options="field:'f4',width:120">提交时间</th>
