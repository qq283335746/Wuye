<%@ Page Title="新建公告" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="AddAnnouncement.aspx.cs" Inherits="TygaSoft.Web.Admin.AboutSite.AddAnnouncement" %>
...
<div class="easyui-panel" style="padding:10px;">
    ...
    <div class="row mt10">
        <span class="rl">&nbsp;</span>
        <div class="fl">
        <a href="javascript:void(0)" class="easyui-linkbutton" data-options="iconCls:'icon-save'" onclick="AddAnnouncement.OnSave()">提交</a>
        </div>
        <span class="clr"></span>
    </div>
</div>
...
<script type="text/javascript" src="/House/Scripts/Admin/AddAnnouncement.js"></script>
