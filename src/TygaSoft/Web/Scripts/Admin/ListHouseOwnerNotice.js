...
var ListHouseOwnerNotice = {
    Init: function () {
        ListHouseOwnerNotice.Grid(sPageIndex, sPageSize);
    },
    ...
    Del: function () {
        try {
            ...
            $.messager.confirm('温馨提醒', '确定要删除吗？', function (r) {
                if (r) {
                    $.ajax({
                        url: "/House/ScriptServices/AdminService.asmx/DelHouseOwnerNotice",
                        type: "post",
